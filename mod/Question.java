...
public class Question {
	//Question Class that involves asking the PLayer a Question when Invoked Upon
	...
	public void addL4() {
		...
		positions.add(new Position(8,11));//3
		positions.add(new Position(11,1));//4
	...
	public boolean askQuestions(int num) {
		if(num == 0) {
	        ...
	        if(b == null) {
	            ...
	            Window.msg("Your turns have decreased by 10");
	        	return false;
	        }
	...
	//Getters for positions of each question
